...
class Vision:
    ...
    def detections(self, img: np.ndarray, draw_img: np.ndarray, x: tuple, kind: str = "aruco") -> tuple:
        ...
        landmark_alphas = np.concatenate((landmark_alphas, landmark_alphas_circles))
        landmark_positions = np.concatenate((landmark_positions, landmark_positions_circles))
        # print(landmark_rs)
        # print(type(landmark_rs))
    ...
    def detect_circles(self, img: np.ndarray):
        ...
        output_green = self.find_centroids(img, self.green_lower, self.green_upper)
